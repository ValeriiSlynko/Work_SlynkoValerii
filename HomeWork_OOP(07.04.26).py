...
class Recipe:
    ...
    def display_info (self):
        print(f"Страва: '{self.name}' має продукти {self.ingredients} Приготування: {self.text} по часу {self.time}")

# Створюємо декілька рецептів
recipes = [
    Recipe("Піца",
            ["борошно", "вода", "дріжджі", "томат", "сир"],
            "Готуємо тісто, додаємо інгредієнти та запікаємо",
...
print("Рецепти страв, які містять інгредієнт 'томат'")
for recipe in recipes:
    if 'томат' in recipe:
        print(recipe)

fast_recipe = min(recipes)
print("\nРецепт з найменшим часом приготування")
fast_recipe.display_info()
